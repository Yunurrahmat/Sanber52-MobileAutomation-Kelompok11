...
TC005- User should not be able to book flight Round Trip - Without Day
# Precondition: User is already logged in with valid credentials
...
TC006- User should not be able to book flight Round Trip- Without Day and Without Start Date, End Date
# Precondition: User is already logged in with valid credentials
# Notes: EXPECTED TO BE FAILED BECAUSE A VALID ISSUE ON THE APPLICATION
    # step : 
    Verify User Is Logged In
...
TC007-User should not be able to book flight Round Trip - empty field
# Precondition: User is already logged in with valid credentials
# Notes: EXPECTED TO BE FAILED BECAUSE A VALID ISSUE ON THE APPLICATION
    # step : 
    Verify User Is Logged In
